  ...
  foreach($fetchhdr as $hdr){
    ...
    <header class="clear-fix">
       ...
       <!-- Sign Up page -->
           ...
           <form action= "<?php echo site_url('loginauthor/check')?>" method="post" id="login" class="input-group">
           ...
           <form id="register" class="input-group" action="<?php echo site_url('blog/saveauthor')?>" method="post">
           
            <input type="text" class="input-field" placeholder="User Id" required id="username" name="username">
            <input type="email" class="input-field" placeholder="Email Id" required id="email" name="email">
