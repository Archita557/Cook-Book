        ...
        <div class="wrapper">
            ...
            <div class="header">
                <div class="header-menu">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo site_url('user/logoutauthor');?>">
            ...
            <div class="sidebar">
               ...
               <center class="profile">
                       ...
                       <img src="<?php echo base_url().'asset/uploads/'.$authorhdr->authorpicture;?>" alt="">
                       <p><?php echo $authorhdr->authorname;?></p>
                   </center>
                ...
                <a href="<?php echo site_url('user');?>" class="menu-btn">
