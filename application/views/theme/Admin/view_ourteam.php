           ...
           <div class="sidebar">
            ...
            <div class="main-container">
                <div class="wrapper_main">
                    <div class="title">
                        View My Team Section
                        </div>

                        <div class="form">
                        <form action="<?php echo site_url('admin/updateourteam/'.$viewourteam->id)?>" method="post" enctype="multipart/form-data">
                            <form action="">
                                <div class="input_field">
                                    <label>Name</label>
                                    <label class="input"><?php echo $viewourteam->name;?></label>
                                </div>
                                <div class="input_field">
                                    <label>Position Title</label>
                                    <label class="input"><?php echo $viewourteam->positiontitle;?></label>
                                </div>
            
                                
                                <div class="input_field">
                                <label>Picture</label>
                                <?php if($viewourteam->picture){?>
                                    <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewourteam->picture);?>">
                                    <?php }?>
                                </div>
