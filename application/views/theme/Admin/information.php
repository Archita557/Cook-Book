...
<html>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo substr($info->address,0,10);?>...</td>
      <td><?php echo substr($info->phone,0,15);?></td>
      <td><?php echo substr($info->email,0,30);?></td>
      <td><img height="50px" width="50px" src="<?php echo base_url().'asset/uploads/'.$info->background;?>"></td>

      <td><a class="btn" href="<?php echo site_url('admin/editinfo/'.$info->id)?>" role="button">Edit</a>
      <a class="btn" href="<?php echo site_url('admin/viewinfo/'.$info->id)?>" role="button">View</a></td>
