           ...
           <div class="sidebar">
            ...
            <div class="main-container">
                <div class="wrapper_main">
                    <div class="title">
                        Edit My Team Section
                        </div>

                        <div class="form">
                        <form action="<?php echo site_url('admin/updateourteam/'.$editourteam->id)?>" method="post" enctype="multipart/form-data">
                            <form action="">
                                <div class="input_field">
                                    <label>Name</label>
                                    <input type="text" name="name" class="input" placeholder="Enter Your messeage" value="<?php echo $editourteam->name;?>">
                                </div>
                                <div class="input_field">
                                    <label>Position Title</label>
                                    <input type="text" name="positiontitle" class="input" placeholder="Enter Your messeage" value="<?php echo $editourteam->positiontitle;?>">
                                </div>
                                ...
                                <div class="picture_field">
                                    ...
                                    <?php if($editourteam->picture){?>
                                    <img width="20%" src="<?php echo site_url('asset/uploads/'.$editourteam->picture);?>">
                                    <?php }?>
                                </div>
