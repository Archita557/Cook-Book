...
<html>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo substr($about->title,0,10);?></td>
      <td><?php echo substr($about->paragraph,0,20);?>...</td>

      <td><img height="50px" width="50px" src="<?php echo base_url().'asset/uploads/'.$about->picture;?>"></td>
      <td><img height="50px" width="50px" src="<?php echo base_url().'asset/uploads/'.$about->background;?>"></td>

      <td><a class="btn" href="<?php echo site_url('admin/editabout/'.$about->id)?>" role="button">Edit</a>
      
      <a class="btn" href="<?php echo site_url('admin/viewabout/'.$about->id)?>" role="button">View</a></td>
