                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateauthor/'.$editauthor->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    ...
                                    <input type="text" name="authorname" class="input" placeholder="Enter Your Name..." value="<?php echo $editauthor->authorname;?>">
                                </div>
                                <div class="input_field">
                                ...
                                <div class="input_field">
                                 ...
                                 <textarea class="textarea" name="authordescription" placeholder="Enter Your Description..."><?php echo $editauthor->authordescription;?></textarea>
                                </div>
