            ...
            <div class="main-container">
                <div class="wrapper_main">
                    <div class="title">
                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateabout/'.$viewabout->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    <label>Title</label>
                                    <label class="input"><?php echo $viewabout->title;?></label>
                                </div>
                                <div class="input_field">
                                    <label>Paragraph</label>
                                 <label class="textarea" style="height: auto;"><?php echo $viewabout->paragraph;?></label>
                                </div>
            
                                
                                <div class="input_field">
                                <label>Picture</label>
                                <?php if($viewabout->picture){?>
                                    <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewabout->picture);?>">
                                    <?php }?>
                                </div>
            
                                <div class="input_field">
                                <label>Background</label>
                                <?php if($viewabout->background){?>
                                <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewabout->background);?>">
                                 <?php }?>
                                </div>
