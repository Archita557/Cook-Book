...
<html>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo substr($team->name,0,10);?>...</td>
      <td><?php echo substr($team->positiontitle,0,10);?>...</td>

      <td><img height="50px" width="50px" src="<?php echo base_url().'asset/uploads/'.$team->picture;?>"></td>
      <td><a class="btn" href="<?php echo site_url('admin/editteam/'.$team->id)?>" role="button">Edit</a>
      
      <a class="btn" href="<?php echo site_url('admin/viewteam/'.$team->id)?>" role="button">View</a></td>
