            ...
            <div class="main-container">
                <div class="wrapper_main">
                    <div class="title">
                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateinformation/'.$viewinformation->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    <label>Address</label>
                                 <label class="textarea" style="height: auto;"><?php echo $viewinformation->address;?></label>
                                </div>
                                <div class="input_field">
                                    <label>Phone</label>
                                    <label class="input"><?php echo $viewinformation->phone;?></label>
                                </div>
                                
                                <div class="input_field">
                                    <label>Email</label>
                                    <label class="input"><?php echo $viewinformation->email;?></label>
                                </div>
                                <div class="input_field">
                                <label>Background</label>
                                <?php if($viewinformation->background){?>
                                <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewinformation->background);?>">
                                <?php }?>
                                </div>
