                ...
                <div class="wrapper_main">
                    <div class="title">
                       Edit About Us Section
                        ...
                        <div class="form">
                            <form action="<?php echo site_url('admin/updateabout/'.$editabout->id)?>" method="post" enctype="multipart/form-data">
                                <div class="input_field">
                                    <label>Title</label>
                                    <input type="text" name="title" class="input" placeholder="Enter Your messeage" value="<?php echo $editabout->title;?>">
                                </div>
                                <div class="input_field">
                                    <label>Paragraph</label>
                                 <textarea class="textarea" name="paragraph" placeholder="Enter Your messeage"><?php echo $editabout->paragraph;?></textarea>
                                </div>
            
                                
                                <div class="picture_field">
                                    <label>Picture</label>
                                    <input type="file" class="photo" name="picture">

                                    <?php if($editabout->picture){?>
                                    <img width="20%" src="<?php echo site_url('asset/uploads/'.$editabout->picture);?>">
                                    <?php }?>
                                </div>
                                ...
                                <div class="photo_field">
                                    ...
                                    <?php if($editabout->background){?>
                                    <img width="20%" src="<?php echo site_url('asset/uploads/'.$editabout->background);?>">
                                    <?php }?>
                                </div>
